...
sealed class FusioNative_FNAppBar_Title_Property: Uno.UX.Property<string>
{
    [Uno.WeakReference] readonly FN.AppBar _obj;
    public FusioNative_FNAppBar_Title_Property(FN.AppBar obj, global::Uno.UX.Selector name) : base(name) { _obj = obj; }
    public override global::Uno.UX.PropertyObject Object { get { return _obj; } }
    public override string Get(global::Uno.UX.PropertyObject obj) { return ((FN.AppBar)obj).Title; }
    public override void Set(global::Uno.UX.PropertyObject obj, string v, global::Uno.UX.IPropertyListener origin) { ((FN.AppBar)obj).SetTitle(v, origin); }
    public override bool SupportsOriginSetter { get { return true; } }
}
